...
{
    public partial class frmCowStatus : Form
    {
        public frmCowStatus()
        {
            InitializeComponent();
        ...
        {
            frmEditCowStatus frmEditData = new frmEditCowStatus(pIsNewMode: true);
        ...
        private void fpsCowType_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            frmEditCowStatus frmEditType = new frmEditCowStatus(pIsNewMode: false);
