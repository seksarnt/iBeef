...
{
    public partial class frmCowHorn : Form
    {
        public frmCowHorn()
        {
            InitializeComponent();
        ...
        {
            frmEditCowHorn frmEditType = new frmEditCowHorn(pIsNewMode: true);
        ...
        private void fpsCowType_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            frmEditCowHorn frmEditType = new frmEditCowHorn(pIsNewMode: false);
