...
{
    public partial class frmCowPurpose : Form
    {
        public frmCowPurpose()
        {
            InitializeComponent();
        }
        ...
        {
            frmEditCowPurpose frmEditData = new frmEditCowPurpose(pIsNewMode: true);
        ...
        private void fpsCowType_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            frmEditCowPurpose frmEditType = new frmEditCowPurpose(pIsNewMode: false);
            frmEditType.DataCode = this.fpsData_Sheet1.Cells.Get(e.Row, _col_code).Text;
            frmEditType.DataName = this.fpsData_Sheet1.Cells.Get(e.Row, _col_name).Text;
            ...
            if (frmEditType.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                this.fpsData_Sheet1.Cells.Get(rowIndex, _col_check).Value = false;
                this.fpsData_Sheet1.Cells.Get(rowIndex, _col_code).Text = frmEditType.DataCode;
                this.fpsData_Sheet1.Cells.Get(rowIndex, _col_name).Text = frmEditType.DataName;
